...
module.exports.add_product= async (req, res) => {
  ...
  const {name, description,price,image,availability,brand,label} = req.body
  try{
    const product=await Product.create({name,description,price,image,availability,brand,label})
...
module.exports.update_product=async(req,res)=>{
  ...
  if(product_id){
    ...
    try{
      const updateproduct= await Product.updateOne({_id:req.params.id},product)
